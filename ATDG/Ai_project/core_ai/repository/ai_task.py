"""
AI Tasks Repository - إدارة مهام الذكاء الاصطناعي في MongoDB

مسؤوليات هذا الـ Repository:
- حفظ المهام الجديدة في قاعدة البيانات
- تحديث حالة المهام الموجودة
- البحث عن المهام بواسطة المعايير المختلفة
- إدارة سجل المهام للتتبع والمراقبة
